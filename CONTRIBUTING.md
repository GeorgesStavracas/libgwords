...
When contributing to the development of libwords, please first discuss the change you wish to
...
1. Ensure your code passes all tests. Run `make check` before creating the pull request.
2. If you're adding new API, they must be documented and have tests associated.
3. You may merge the pull request in once you have the sign-off of the maintainers, or if you
   do not have permission to do that, you may request the second reviewer to merge it for you.

## Code of Conduct

Libwords is a project developed based on GNOME Code of Conduct. You can read it below:
